...
| `lsb_release -a` | Show Linux distribution |
...
| `nano` | Text editor |
| `ls -R` | List directory tree |

## Skills Learned
- Navigating cloud-based Linux environments securely via browser.
- User management: creating accounts, assigning shells, and granting sudo access.
- Gathering system specifications from the command line.
- Organizing files using standard directory conventions.
- Writing clean, professional documentation using Markdown syntax.
- Structuring a technical portfolio for professional presentation.
